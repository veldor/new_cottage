...
if (!empty($data)) {
    ...
    foreach ($data as $datum) {
        if (CottagesHandler::findOne($datum->cottage_number)->is_target) {
    ...
    echo "<h1 class='text-center'>За этот год ещё никто ничего не платил</h1>";
}
